...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-47-18-165Z-x1-2195123f/playwright/console-2026-09-14T17-47-21-047Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-47-18-165Z-x1-2195123f/playwright/console-2026-09-14T17-47-21-047Z.log#L2"
}
```
...
```json
{
  "result": "Found 2 matches for \"100099\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e3]:\n        - rowgroup [ref=f2e4]:\n          - row [ref=f2e5]:\n            - rowheader \"Requested member\" [ref=f2e6]\n            - cell \"100099\" [ref=f2e7]\n          - row [ref=f2e8]:\n            - rowheader \"Operator action\" [ref=f2e9]\n            - cell \"Wait briefly, then retry the same inquiry.\" [ref=f2e10]\n      - paragraph [ref=f2e11]:\n        - link \"F5 - Retry host request\" [ref=f2e12] [cursor=pointer]:\n          - /url: /app/member/100099?retry=1\n      - generic [ref=f2e13]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "result": "Found 1 match for \"100099\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - 'rowheader \"Member #\" [ref=f2e5]'\n            - cell \"100099\" [ref=f2e6]\n            - rowheader \"Status\" [ref=f2e7]\n            - cell \"Active\" [ref=f2e8]\n          - row [ref=f2e9]:"
}
```
...
```json
{
  "text": "Morgan Mockdata"
}
```
- Result
```json
{
  "result": "Found 1 match for \"Morgan Mockdata\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            ...\n            - cell \"Active\" [ref=f2e8]\n          - row [ref=f2e9]:\n            - rowheader \"Name\" [ref=f2e10]\n            - cell \"Morgan Mockdata\" [ref=f2e11]\n            - rowheader \"Member since\" [ref=f2e12]\n            - cell \"2021-11-03\" [ref=f2e13]\n          - row [ref=f2e14]:"
}
```
