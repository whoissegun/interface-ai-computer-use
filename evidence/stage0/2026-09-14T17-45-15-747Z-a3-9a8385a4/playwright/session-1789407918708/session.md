...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-45-15-747Z-a3-9a8385a4/playwright/console-2026-09-14T17-45-19-066Z.log#L1"
}
```
...
```json
{
  "filename": "final-review-screen.png",
  "scale": "css"
}
```
- Result
```json
{
  "result": "- [Screenshot of viewport](./final-review-screen.png)"
}
```
