...
```json
{
  "result": "No matches found for \"EXPIRED\"."
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-56-54-776Z-e6-6585e221/playwright/console-2026-09-14T17-56-58-444Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-56-54-776Z-e6-6585e221/playwright/console-2026-09-14T17-56-58-444Z.log#L2"
}
```
...
```json
{
  "result": "Found 1 match for \"EXPIRED\":\n\n- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      ...\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: Session Expired COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: SESSION E01The CoreBank session is no longer valid. Sign-in by a human operator is required.\n      - paragraph [ref=f2e3]: The operation has stopped. Do not retry automatically.\n      - paragraph [ref=f2e4]:"
}
```
...
```json
{
  "result": "Found 1 match for \"SESSION E01\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: Session Expired COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: SESSION E01The CoreBank session is no longer valid. Sign-in by a human operator is required.\n      - paragraph [ref=f2e3]: The operation has stopped. Do not retry automatically.\n      - paragraph [ref=f2e4]:\n        - link \"Return to member lookup\" [ref=f2e5] [cursor=pointer]:"
}
```
...
```json
{
  "result": "Found 2 matches for \"CoreBank\":\n\n- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      ...\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: Session Expired COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: SESSION E01The CoreBank session is no longer valid. Sign-in by a human operator is required.\n      - paragraph [ref=f2e3]: The operation has stopped. Do not retry automatically.\n      - paragraph [ref=f2e4]:\n        - link \"Return to member lookup\" [ref=f2e5] [cursor=pointer]:"
}
```
