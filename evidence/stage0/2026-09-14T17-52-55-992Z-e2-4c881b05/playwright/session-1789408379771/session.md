...
```json
{
  "element": "MEMBER LOOKUP link in top nav",
  "target": "f1e3"
}
```
- Result
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-52-55-992Z-e2-4c881b05/playwright/console-2026-09-14T17-52-59-963Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-52-55-992Z-e2-4c881b05/playwright/console-2026-09-14T17-52-59-963Z.log#L2"
}
```
