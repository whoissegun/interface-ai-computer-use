...
```json
{
  "element": "SELECT link for MBR-10 Member inquiry and account balances",
  "target": "f2e13"
}
```
- Result
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-49-24-777Z-chain1-b71d0916/playwright/console-2026-09-14T17-49-28-769Z.log#L1"
}
```
