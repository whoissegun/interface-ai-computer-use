...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-54-55-192Z-e3-3058816b/playwright/console-2026-09-14T17-54-59-410Z.log#L1"
}
```
...
```json
{
  "element": "Opening Deposit textbox",
  "target": "f2e13",
  "text": "-5"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-54-55-192Z-e3-3058816b/playwright/console-2026-09-14T17-54-59-410Z.log#L2"
}
```
