...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-56-54-776Z-e6-7de3fb0e/playwright/console-2026-09-14T17-56-58-224Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-56-54-776Z-e6-7de3fb0e/playwright/console-2026-09-14T17-56-58-224Z.log#L2"
}
```
...
```json
{
  "filename": "member_expired_result.png",
  "scale": "css"
}
```
- Result
```json
{
  "result": "- [Screenshot of viewport](./member_expired_result.png)"
}
```
