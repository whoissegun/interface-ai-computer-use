...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [active] [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: Operations Menu COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: TRAINING ENVIRONMENT. All people, balances, and transactions are fictional.\n      - table [ref=f2e3]:\n        - rowgroup [ref=f2e4]:\n          - row \"Function Description Go\" [ref=f2e5]\n          - row \"MBR-10 Member inquiry and account balances SELECT\" [ref=f2e9]\n          - row \"ACCT-22 New share/sub-account setup (simulation) SELECT MEMBER\" [ref=f2e14]\n          - row \"Pending work None --\" [ref=f2e19]\n      - table [ref=f2e23]:\n        - rowgroup [ref=f2e24]:\n          - row \"System Status\" [ref=f2e25]\n          - row \"Host ONLINE\" [ref=f2e27]\n          - row \"Business date 09/11/2026\" [ref=f2e30]\n          - row \"Queue Normal\" [ref=f2e33]\n      - generic [ref=f2e36]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "element": "ACCT-22 New share/sub-account setup (simulation) SELECT MEMBER",
  "target": "f2e14"
}
```
- Result
...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-45-15-747Z-a3-eeddfb14/playwright/console-2026-09-14T17-45-18-417Z.log#L1"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: Member Relationship Summary COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - 'row \"Member # 100042 Status Active\" [ref=f2e4]'\n          - row \"Name Avery Example Member since 2018-04-17\" [ref=f2e9]\n          - row \"Address 42 Fiction Lane, Sampleton, ON A1A 1A1\" [ref=f2e14]\n          - row \"Telephone (555) 010-0042\" [ref=f2e17]\n      - heading \"Deposit Relationships\" [level=2] [ref=f2e20]\n      - table [ref=f2e21]:\n        - rowgroup [ref=f2e22]:\n          - row \"Account Product Current Balance Available Balance Action\" [ref=f2e23]\n          - row \"S-0042-01 Regular Savings $2,481.37 $2,381.37 INQUIRE\" [ref=f2e29]\n          - row \"C-0042-08 Chequing $918.12 $918.12 INQUIRE\" [ref=f2e36]\n      - button \"F9 - Open New Share/Sub-account\" [ref=f2e44]\n      - paragraph [ref=f2e45]:\n        - link \"F4 - New member lookup\" [ref=f2e46] [cursor=pointer]:\n          - /url: /app/member-search\n      - generic [ref=f2e47]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row \"Member 100042 — Avery Example\" [ref=f2e4]\n          - row \"Mode PREPARE / NO POST\" [ref=f2e7]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\" [selected]\n          - option \"S01 - Regular Savings\"\n          - option \"S14 - Holiday Savings\"\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"0.00\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "snapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - rowheader \"Member\" [ref=f2e5]\n            - cell \"100042 — Avery Example\" [ref=f2e6]\n          - row [ref=f2e7]:\n            - rowheader \"Mode\" [ref=f2e8]\n            - cell \"PREPARE / NO POST\" [ref=f2e9]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\"\n          - option \"S01 - Regular Savings\"\n          - option \"S14 - Holiday Savings\" [selected]\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"0.00\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row \"Member 100042 — Avery Example\" [ref=f2e4]\n          - row \"Mode PREPARE / NO POST\" [ref=f2e7]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\"\n          - option \"S01 - Regular Savings\"\n          - option \"S14 - Holiday Savings\" [selected]\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]: Rainy Day\n        - text: Opening Deposit (CAD)\n        - textbox [active] [ref=f2e13]: \"25\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: New Sub-account — Final Review COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: REVIEW CHECKPOINT. Verify all fields. No account exists yet.\n      - table [ref=f2e3]:\n        - rowgroup [ref=f2e4]:\n          - row \"Member 100042 — Avery Example\" [ref=f2e5]\n          - row \"Product S14 - Holiday Savings\" [ref=f2e8]\n          - row \"Nickname Rainy Day\" [ref=f2e11]\n          - row \"Opening deposit CAD 25.00\" [ref=f2e14]\n          - row \"Statements Electronic\" [ref=f2e17]\n          - row \"Posting mode SIMULATION — NO CORE WRITE\" [ref=f2e20]\n      - button \"SIMULATE FINAL SUBMISSION\" [ref=f2e24]\n      - paragraph [ref=f2e25]:\n        - link \"F4 - Correct entry\" [ref=f2e26] [cursor=pointer]:\n          - /url: /app/subaccount/new?member=100042\n        - link \"Cancel request\" [ref=f2e27] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e28]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "filename": "holiday-savings-review-screen.png",
  "scale": "css"
}
```
- Result
```json
{
  "result": "- [Screenshot of viewport](./holiday-savings-review-screen.png)"
}
```
