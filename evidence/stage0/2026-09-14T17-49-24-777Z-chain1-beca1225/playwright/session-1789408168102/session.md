...
```json
{
  "element": "SELECT link under MBR-10",
  "target": "f2e13"
}
```
- Result
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-49-24-777Z-chain1-beca1225/playwright/console-2026-09-14T17-49-28-368Z.log#L1"
}
```
