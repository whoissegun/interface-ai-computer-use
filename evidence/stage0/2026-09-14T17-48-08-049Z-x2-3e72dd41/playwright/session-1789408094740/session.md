...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-48-08-049Z-x2-3e72dd41/playwright/console-2026-09-14T17-48-14-922Z.log#L1"
}
```
...
```json
{
  "result": "- [Screenshot of viewport](./final-review.png)"
}
```
