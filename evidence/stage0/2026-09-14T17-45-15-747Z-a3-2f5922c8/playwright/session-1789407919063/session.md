...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-45-15-747Z-a3-2f5922c8/playwright/console-2026-09-14T17-45-19-316Z.log#L1"
}
```
...
```json
{
  "result": "- [Screenshot of full page](./review-screen.png)"
}
```
