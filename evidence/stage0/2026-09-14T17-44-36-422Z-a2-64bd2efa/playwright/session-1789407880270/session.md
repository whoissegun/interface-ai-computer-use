...
```json
{
  ...
  "events": "- New console entries: evidence/stage0/2026-09-14T17-44-36-422Z-a2-64bd2efa/playwright/console-2026-09-14T17-44-40-555Z.log#L1"
}
```
...
```json
{
  "element": "INQUIRE link for S-0042-01",
  "target": "f2e35"
}
```
- Result
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "snapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: Account Balance Inquiry COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - rowheader \"Member\" [ref=f2e5]\n            - cell \"100042 — Avery Example\" [ref=f2e6]\n          - row [ref=f2e7]:\n            - rowheader \"Account\" [ref=f2e8]\n            - cell \"S-0042-01\" [ref=f2e9]\n          - row [ref=f2e10]:\n            - rowheader \"Product\" [ref=f2e11]\n            - cell \"Regular Savings\" [ref=f2e12]\n          - row [ref=f2e13]:\n            - rowheader \"Ledger balance\" [ref=f2e14]\n            - cell \"$2,481.37\" [ref=f2e15]\n          - row [ref=f2e16]:\n            - rowheader \"Available balance\" [ref=f2e17]\n            - cell \"$2,381.37\" [ref=f2e18]\n      - paragraph [ref=f2e19]:\n        - link \"F3 - Return to member\" [ref=f2e20] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1] [box=0,0,1440,1000]:\n  - iframe [ref=e2] [box=0,0,1440,72]:\n    - generic [ref=f1e1] [box=0,0,1440,68]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer] [box=441,26,40,16]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer] [box=578,26,116,16]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer] [box=864,26,65,16]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3] [box=0,75,1440,925]:\n    - generic [active] [ref=f2e1] [box=0,0,1440,278]:\n      - text: Account Balance Inquiry COREBANK / TELLER 7.4\n      - table [ref=f2e2] [box=12,52,640,146]:\n        - rowgroup [ref=f2e3] [box=13,53,639,145]:\n          - row [ref=f2e4] [box=13,53,639,29]:\n            - rowheader \"Member\" [ref=f2e5] [box=13,53,167,29]\n            - cell \"100042 — Avery Example\" [ref=f2e6] [box=180,53,472,29]\n          - row [ref=f2e7] [box=13,82,639,29]:\n            - rowheader \"Account\" [ref=f2e8] [box=13,82,167,29]\n            - cell \"S-0042-01\" [ref=f2e9] [box=180,82,472,29]\n          - row [ref=f2e10] [box=13,111,639,29]:\n            - rowheader \"Product\" [ref=f2e11] [box=13,111,167,29]\n            - cell \"Regular Savings\" [ref=f2e12] [box=180,111,472,29]\n          - row [ref=f2e13] [box=13,140,639,29]:\n            - rowheader \"Ledger balance\" [ref=f2e14] [box=13,140,167,29]\n            - cell \"$2,481.37\" [ref=f2e15] [box=180,140,472,29]\n          - row [ref=f2e16] [box=13,169,639,29]:\n            - rowheader \"Available balance\" [ref=f2e17] [box=13,169,167,29]\n            - cell \"$2,381.37\" [ref=f2e18] [box=180,169,472,29]\n      - paragraph [ref=f2e19] [box=12,211,1416,16]:\n        - link \"F3 - Return to member\" [ref=f2e20] [cursor=pointer] [box=12,211,132,16]:\n          - /url: /app/member/100042\n      - generic [ref=f2e21] [box=0,901,1440,24]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
