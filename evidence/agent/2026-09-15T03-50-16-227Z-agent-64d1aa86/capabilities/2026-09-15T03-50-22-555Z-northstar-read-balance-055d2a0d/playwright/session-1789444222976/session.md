...
```json
{
  ...
  "events": "- New console entries: evidence/agent/2026-09-15T03-50-16-227Z-agent-64d1aa86/capabilities/2026-09-15T03-50-22-555Z-northstar-read-balance-055d2a0d/playwright/console-2026-09-15T03-50-23-142Z.log#L1"
}
```
...
```json
{
  "result": "Found 2 matches for \"S-0042-01\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e21]:\n        - rowgroup [ref=f2e22]:\n          - row [ref=f2e23]:\n            ...\n            - columnheader \"Available Balance\" [ref=f2e27]\n            - columnheader \"Action\" [ref=f2e28]\n          - row [ref=f2e29]:\n            - cell \"S-0042-01\" [ref=f2e30]\n            - cell \"Regular Savings\" [ref=f2e31]\n            - cell \"$2,481.37\" [ref=f2e32]\n            - cell \"$2,381.37\" [ref=f2e33]\n            - cell [ref=f2e34]:\n              - link \"INQUIRE\" [ref=f2e35] [cursor=pointer]:\n                - /url: /app/account?acct=S-0042-01\n          - row [ref=f2e36]:\n            - cell \"C-0042-08\" [ref=f2e37]\n            - cell \"Chequing\" [ref=f2e38]"
}
```
