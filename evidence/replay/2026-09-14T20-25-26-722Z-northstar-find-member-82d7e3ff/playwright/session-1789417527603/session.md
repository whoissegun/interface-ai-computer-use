...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-14T20-25-26-722Z-northstar-find-member-82d7e3ff/playwright/console-2026-09-14T20-25-27-987Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-14T20-25-26-722Z-northstar-find-member-82d7e3ff/playwright/console-2026-09-14T20-25-27-987Z.log#L2"
}
```
...
```json
{
  "filename": "/Users/divinejojolola/Documents/ChatGPT/interface.ai/evidence/replay/2026-09-14T20-25-26-722Z-northstar-find-member-82d7e3ff/failure.png",
  "scale": "device"
}
```
- Result
```json
{
  "result": "- [Screenshot of viewport](evidence/replay/2026-09-14T20-25-26-722Z-northstar-find-member-82d7e3ff/failure.png)"
}
```
