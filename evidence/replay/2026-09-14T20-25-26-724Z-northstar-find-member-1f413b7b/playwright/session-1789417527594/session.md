...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-14T20-25-26-724Z-northstar-find-member-1f413b7b/playwright/console-2026-09-14T20-25-28-009Z.log#L1"
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-14T20-25-26-724Z-northstar-find-member-1f413b7b/playwright/console-2026-09-14T20-25-28-009Z.log#L2"
}
```
...
```json
{
  "filename": "/Users/divinejojolola/Documents/ChatGPT/interface.ai/evidence/replay/2026-09-14T20-25-26-724Z-northstar-find-member-1f413b7b/failure.png",
  "scale": "device"
}
```
- Result
```json
{
  "result": "- [Screenshot of viewport](evidence/replay/2026-09-14T20-25-26-724Z-northstar-find-member-1f413b7b/failure.png)"
}
```
