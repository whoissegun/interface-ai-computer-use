...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-15T03-13-59-937Z-northstar-prepare-subaccount-9980432b/playwright/console-2026-09-15T03-14-00-593Z.log#L1"
}
```
...
```json
{
  "text": "Supervisor: acknowledge review"
}
```
- Result
```json
{
  "result": "Found 1 match for \"Supervisor: acknowledge review\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - text: New Sub-account — Final Review COREBANK / TELLER 7.4\n      - generic [ref=f2e2]: \"HUMAN REVIEW REQUIRED — HOLD H91Reason: member relationship flag R17. Automation must stop here and leave this browser session open for an authorized supervisor.\"\n      - 'button \"Supervisor: acknowledge review\" [ref=f2e4]'\n      - table [ref=f2e5]:\n        - rowgroup [ref=f2e6]:\n          - row [ref=f2e7]:"
}
```
