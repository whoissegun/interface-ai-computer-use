...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-15T03-08-48-469Z-northstar-prepare-subaccount-cb3c6970/playwright/console-2026-09-15T03-08-49-064Z.log#L1"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: MBR-10 Member Inquiry COREBANK / TELLER 7.4\n      - generic [ref=f2e2]:\n        - text: Member Number\n        - textbox [active] [ref=f2e3]: \"100042\"\n        - text: Search Scope\n        - combobox [ref=f2e4]:\n          - option \"All relationships\" [selected]\n          - option \"Deposit only\"\n        - button \"F6 - Locate\" [ref=f2e5]\n        - button \"Clear\" [ref=f2e6]\n      - paragraph [ref=f2e7]: Enter the full member number. Name search is unavailable during nightly indexing.\n      - paragraph [ref=f2e8]:\n        - link \"F3 - Return to menu\" [ref=f2e9] [cursor=pointer]:\n          - /url: /app/home\n      - generic [ref=f2e10]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "text": "F9 - Open New Share/Sub-account"
}
```
- Result
```json
{
  "result": "Found 1 match for \"F9 - Open New Share/Sub-account\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e21]:\n        - rowgroup [ref=f2e22]:\n          ...\n          - row [ref=f2e36]:\n            ...\n            - cell [ref=f2e41]:\n              - link \"INQUIRE\" [ref=f2e42] [cursor=pointer]:\n                - /url: /app/account?acct=C-0042-08\n      - button \"F9 - Open New Share/Sub-account\" [ref=f2e44]\n      - paragraph [ref=f2e45]:\n        - link \"F4 - New member lookup\" [ref=f2e46] [cursor=pointer]:\n          - /url: /app/member-search"
}
```
...
```json
{
  "element": "F9 - Open New Share/Sub-account",
  "target": "f2e44"
}
```
- Result
...
```json
{
  "result": "Found 1 match for \"Product Code\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          ...\n          - row [ref=f2e7]:\n            - rowheader \"Mode\" [ref=f2e8]\n            - cell \"PREPARE / NO POST\" [ref=f2e9]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\" [selected]\n          - option \"S01 - Regular Savings\""
}
```
...
```json
{
  "element": "combobox near Product Code",
  "target": "f2e11",
  "values": [
    "S01 - Regular Savings"
  ]
...
```json
{
  "result": "Found 1 match for \"Account Nickname\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [active] [ref=f2e1]:\n      - generic [ref=f2e10]:\n        - combobox [ref=f2e11]:\n          ...\n          - option \"S01 - Regular Savings\" [selected]\n          - option \"S14 - Holiday Savings\"\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"0.00\""
}
```
...
```json
{
  "element": "textbox near Account Nickname",
  "target": "f2e12",
  "text": "Invalid Test"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - rowheader \"Member\" [ref=f2e5]\n            - cell \"100042 — Avery Example\" [ref=f2e6]\n          - row [ref=f2e7]:\n            - rowheader \"Mode\" [ref=f2e8]\n            - cell \"PREPARE / NO POST\" [ref=f2e9]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\"\n          - option \"S01 - Regular Savings\" [selected]\n          - option \"S14 - Holiday Savings\"\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [active] [ref=f2e12]: Invalid Test\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"0.00\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "result": "Found 1 match for \"Opening Deposit (CAD)\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - generic [ref=f2e10]:\n        - combobox [ref=f2e11]:\n          ...\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [active] [ref=f2e12]: Invalid Test\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"0.00\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:"
}
```
...
```json
{
  "element": "textbox near Opening Deposit (CAD)",
  "target": "f2e13",
  "text": "-5"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "inlineSnapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - rowheader \"Member\" [ref=f2e5]\n            - cell \"100042 — Avery Example\" [ref=f2e6]\n          - row [ref=f2e7]:\n            - rowheader \"Mode\" [ref=f2e8]\n            - cell \"PREPARE / NO POST\" [ref=f2e9]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\"\n          - option \"S01 - Regular Savings\" [selected]\n          - option \"S14 - Holiday Savings\"\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]: Invalid Test\n        - text: Opening Deposit (CAD)\n        - textbox [active] [ref=f2e13]: \"-5\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "result": "Found 2 matches for \"Electronic\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - generic [ref=f2e10]:\n        - textbox [active] [ref=f2e13]: \"-5\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper"
}
```
...
{
  "page": "- Page URL: https://target-app-gamma.vercel.app/\n- Page Title: Northstar CU CoreBank",
  "snapshot": "- generic [ref=e1]:\n  - iframe [ref=e2]:\n    - generic [ref=f1e1]:\n      - text: NORTHSTAR CU\n      - link \"HOME\" [ref=f1e2] [cursor=pointer]:\n        - /url: /app/home\n      - link \"MEMBER LOOKUP\" [ref=f1e3] [cursor=pointer]:\n        - /url: /app/member-search\n      - link \"OPS HELP\" [ref=f1e4] [cursor=pointer]:\n        - /url: /app/help\n      - text: \"BRANCH 019 | USER: DEMO7\"\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - text: ACCT-22 New Share/Sub-account COREBANK / TELLER 7.4\n      - table [ref=f2e2]:\n        - rowgroup [ref=f2e3]:\n          - row [ref=f2e4]:\n            - rowheader \"Member\" [ref=f2e5]\n            - cell \"100042 — Avery Example\" [ref=f2e6]\n          - row [ref=f2e7]:\n            - rowheader \"Mode\" [ref=f2e8]\n            - cell \"PREPARE / NO POST\" [ref=f2e9]\n      - generic [ref=f2e10]:\n        - text: Product Code\n        - combobox [ref=f2e11]:\n          - option \"-- choose --\"\n          - option \"S01 - Regular Savings\" [selected]\n          - option \"S14 - Holiday Savings\"\n          - option \"S27 - Youth Savings\"\n        - text: Account Nickname\n        - textbox [ref=f2e12]: Invalid Test\n        - text: Opening Deposit (CAD)\n        - textbox [ref=f2e13]: \"-5\"\n        - text: Statement Delivery\n        - generic [ref=f2e14]:\n          - radio \"Electronic\" [checked] [active] [ref=f2e15]\n          - text: Electronic\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review.\n      - generic [ref=f2e21]: Northstar Community Credit Union — TRAINING SYSTEM — fictitious data only"
}
```
...
```json
{
  "text": "F8 - Continue to Review"
}
```
- Result
```json
{
  "result": "Found 1 match for \"F8 - Continue to Review\":\n\n- generic [ref=e1]:\n  - iframe [active] [ref=e3]:\n    - generic [ref=f2e1]:\n      - generic [ref=f2e10]:\n        - generic [ref=f2e16]:\n          - radio \"Paper\" [ref=f2e17]\n          - text: Paper\n        - button \"F8 - Continue to Review\" [ref=f2e18]\n        - link \"Cancel\" [ref=f2e19] [cursor=pointer]:\n          - /url: /app/member/100042\n      - generic [ref=f2e20]: Amounts of CAD 5,000.00 or more and flagged relationships require human supervisor review."
}
```
...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-15T03-08-48-469Z-northstar-prepare-subaccount-cb3c6970/playwright/console-2026-09-15T03-08-49-064Z.log#L2"
}
```
