...
```json
{
  ...
  "events": "- New console entries: evidence/replay/2026-09-15T03-08-37-053Z-northstar-read-balance-d9507b8d/playwright/console-2026-09-15T03-08-37-612Z.log#L1"
}
```
...
```json
{
  "result": "No matches found for \"S-NOT-THERE\"."
}
```
